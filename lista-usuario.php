	...
	<section id="container">
        ...
        <table>
            ...
            <?php 
                ...
                $query = mysqli_query($conexion, "SELECT u.idusuario, u.nombre, u.correo, u.usuario, r.rol FROM usuario u INNER JOIN rol r ON u.rol = r.idrol ORDER BY idusuario ASC LIMIT $desde, $por_pagina");
