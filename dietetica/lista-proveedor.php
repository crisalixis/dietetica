...
<body>
	...
	<section id="container">
        ...
        <table>
            ...
            <?php 
                //Paginador
                $sql_register = mysqli_query($conexion, "SELECT COUNT(*) as total_registro FROM proveedor WHERE estado = 1");
                ...
                $query = mysqli_query($conexion, "SELECT * FROM proveedor WHERE estado = 1 ORDER BY codproveedor ASC LIMIT $desde, $por_pagina");
