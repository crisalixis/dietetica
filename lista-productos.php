	...
	<section id="container">
        ...
        <table>
            ...
            <?php 
                ...
                $query = mysqli_query($conexion, "SELECT pcodproducto, p.descripcion, p.precio, p.existencia, pr.nombre, p.foto FROM producto p INNER JOIN proveedor pr ON p.nombre_proveedor = pr.codproveedor ORDER BY p.codproducto ASC LIMIT $desde, $por_pagina");
